...
const SaitamaSimulation = ({ onClose }) => {
    ...
    return (
        <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[100] bg-[#f8fafc] flex overflow-hidden text-[#1e293b] font-sans"
        >
            {/* Sidebar */}
            <div className="w-64 bg-white border-r border-slate-200 hidden md:flex flex-col p-6">
                ...
                <div className="mt-auto pt-6 border-t border-slate-100">
                    <button onClick={onClose} className="w-full flex items-center gap-3 px-4 py-3 text-red-500 hover:bg-red-50 rounded-xl transition-colors">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                        </svg>
                        <span className="text-sm font-medium">Keluar Simulasi</span>
                    </button>
                </div>
            </div>
                    ...
                    <div className="max-w-6xl mx-auto space-y-6">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-[#1e3a8a] rounded-[2rem] p-8 text-white relative overflow-hidden shadow-xl shadow-blue-900/20">
                                    <div className="absolute bottom-0 right-0 w-32 h-32 bg-white/10 rounded-full -mb-16 -mr-16 blur-2xl"></div>
                                    <h4 className="font-black text-xl mb-2 relative z-10">Portfolio Live</h4>
                                    <p className="text-white/60 text-xs leading-relaxed mb-6 relative z-10">Ini adalah contoh sistem otomasi evaluasi yang kami bangun untuk PT Saitama.</p>
                                    <button onClick={onClose} className="w-full bg-white text-[#1e3a8a] py-3 rounded-xl text-xs font-black uppercase tracking-widest hover:bg-opacity-90 transition-all active:scale-95 shadow-lg shadow-black/10 relative z-10">Tutup Demo</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            {/* Close Button - Mob Only */}
            <button
                onClick={onClose}
                className="fixed bottom-6 right-6 md:hidden w-14 h-14 bg-[#1e3a8a] text-white rounded-full shadow-2xl flex items-center justify-center z-[110]"
            >
