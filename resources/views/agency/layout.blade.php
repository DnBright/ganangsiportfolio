...
<head>
    ...
    <title>@yield('title', 'Agency The Dark and Bright')</title>
...
<body>
    <header>
        <div class="container">
            <nav>
                <div><strong>Agency The Dark and Bright</strong></div>
                <div>
                    <a href="{{ route('agency.home') }}">Beranda</a>
                    <a href="{{ route('agency.programs') }}">Program</a>
                    <a href="{{ route('agency.contact') }}">Kontak</a>
                </div>
            </nav>
        </div>
    </header>
    ...
    <footer>
        <div class="container">
            <p>&copy; {{ date('Y') }} Agency The Dark and Bright. Semua hak dilindungi.</p>
        </div>
    </footer>
</body>
</html>
